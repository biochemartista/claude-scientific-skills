...
- Document processing: LiteParse (local PDF/document parsing with bounding boxes and OCR), Document Skills (PDF, DOCX, PPTX, XLSX)
...
- Document processing: LiteParse, XLSX, MarkItDown, Document Skills
